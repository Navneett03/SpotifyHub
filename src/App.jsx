                ...
                <div className="flex flex-1 min-h-screen">
                  ...
                  <main className="flex-1 relative z-10 overflow-y-auto h-screen">
                    <Routes>
                      ...
                      <Route path="/trending-tracks" element={<TrendingTracksPage />} />
                      <Route path="/genre-insights" element={<GenreInsightsPage />} />
                      <Route path="/artist-rankings" element={<ArtistRankingsPage />} />
                      <Route path="/my-listening" element={<MyListeningPage />} />
                      <Route path="/send-newsletters" element={<SendNewslettersPage />} />
